              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">
                    Learn the principles of creating a visually appealing and
                    user-friendly website. Discover design techniques that
                    reflect your brand identity, engage visitors, and provide a
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">
                    Optimize your website for speed and search engine rankings.
                    Explore best practices for improving load times and SEO to
                    ensure your site performs at its best and reaches a wider
                    audience.
                  </p>
                  <div className="flex items-center flex-wrap ">
                    <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
